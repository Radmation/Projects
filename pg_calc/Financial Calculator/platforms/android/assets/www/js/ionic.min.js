...
'use strict';
  ...
  // When an item is dragged, we need to reorder any user_details for sorting purposes
  ...
  /**
   * The ListView handles a list of user_details. It will process drag animations, edit mode,
  ...
  ionic.views.ListView = ionic.views.View.inherit({
    ...
    didScroll: function(e) {
      ...
      if (self.isVirtual) {
        ...
        // Get the user_details we need to remove
    ...
    didStopScrolling: function() {
      if (this.isVirtual) {
        ...
        // Once scrolling stops, check if we need to remove old user_details
