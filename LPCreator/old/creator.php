    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">
                <h4>THE <span class="text-green">ULTIMATE LANDING PAGE CREATOR</span></h4>
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-6" id="ajax_form_wrap">
                    ...
                    <form class="form-horizontal" id="ajax-form">
                        ...
                        <h4>The <code>&lt;title&gt;</code> and <code>&lt;h1&gt;</code> will contain these words added together. Example: <em>Denver Snow Cones</em></h4>
                        <h5 class="text-muted">Creates landing pages with SEO in mind for every possible combination of Options</h5>
                ...
                <div class="col-md-6">
                    <iframe src="http://dev.kbnetleads.com/charter/temp/index.html">
